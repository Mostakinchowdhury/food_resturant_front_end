...
function Navbar() {
  ...
  return (
    <>
      <header className="lg:flexcontainer hidden lg:flex justify-between">
        <Link href="/" className={`${poppins.className} navlink text-bg1`}>
      ...
      <Foldnav cls="divide-x-[2px]  divide-black lg:hidden" />
    </>
  )
}
